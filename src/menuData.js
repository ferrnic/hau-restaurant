...
export const carte = [
  {
    name: "Nouveauté",
    items: [
      { name: "Un menu unique à 45 euros à la vietnamienne!\n" +
          "\n" +
          ...
          "\n" +
          "Sa composition est repensée régulièrement afin de vous servir des produits frais et de qualités (entrée, potages, plusieurs plats différents, dessert). \n" +
          "\n" +

...
export const homeDescription = "Chez Hau, on mange une cuisine fine aux saveurs asiatiques, fraîche et toujours repensée, accompagnée d’une belle carte de vin biologique et naturelle. Un voyage gastronomique proposé à midi comme au soir dans un cadre unique rempli d’histoire.";

export const carteTitle = "Hau Restaurant | La carte";
export const carteDescription = "La carte du Hau restaurant : une cuisine fine aux saveurs asiatiques, fraîche et toujours repensée.";
